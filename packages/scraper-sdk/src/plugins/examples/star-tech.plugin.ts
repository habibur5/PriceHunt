...
export class StarTechPlugin implements ScraperPlugin {
  readonly metadata: ScraperPluginMetadata = {
    key: 'star-tech',
    name: 'Star Tech Scraper Plugin',
    version: '1.0.0',
    storeName: 'Star Tech',
    storeSlug: 'star-tech',
  ...
  constructor(private readonly pluginKey: ScraperPluginKey = 'star-tech') {}
  ...
  async healthCheck(): Promise<ScraperHealthReport> {
    return {
      ...
      status: 'healthy',
      checkedAt: new Date(),
      message: 'Star Tech plugin template is operational.',
